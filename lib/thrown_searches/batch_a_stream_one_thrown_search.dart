...
class MyBatchAStreamOneSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyBatchAStreamOneSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((batchAStreamOne) => batchAStreamOne.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((batchAStreamOne) => batchAStreamOne.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          batchAStreamOneNotifier.currentBatchAStreamOne = search[position];
