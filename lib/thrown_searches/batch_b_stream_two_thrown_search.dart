...
class MyBatchBStreamTwoSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyBatchBStreamTwoSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((batchBStreamTwo) => batchBStreamTwo.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((batchBStreamTwo) => batchBStreamTwo.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          batchBStreamTwoNotifier.currentBatchBStreamTwo = search[position];
