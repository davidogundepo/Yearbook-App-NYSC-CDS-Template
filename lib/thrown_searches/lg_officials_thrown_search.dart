...
import '../details_pages/lg_officials_details_page.dart';
...
class MyLGOfficialsSearch extends SearchDelegate {
  final List all;

  MyLGOfficialsSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((lgOfficials) => lgOfficials.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((lgOfficials) => lgOfficials.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          lgOfficialsNotifier.currentLGOfficials = search[position];
