...
Color modalColor = Color.fromRGBO(125, 173, 167, 1.0);
...
Color dialogBackgroundColor = Color.fromRGBO(125, 173, 167, 1.0);
...
class MyBatchBStreamOneSearch extends SearchDelegate {
  ...
  MyBatchBStreamOneSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((batchBStreamOne) => batchBStreamOne.name.contains(query2)).toList();
                ...
                child: Container(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        batchBStreamOneNotifier.currentBatchBStreamOne = search[position];
