...
import '../details_pages/batch_c_stream_one_details_page.dart';
...
class MyBatchCStreamOneSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyBatchCStreamOneSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((batchCStreamOne) => batchCStreamOne.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((batchCStreamOne) => batchCStreamOne.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          batchCStreamOneNotifier.currentBatchCStreamOne = search[position];
