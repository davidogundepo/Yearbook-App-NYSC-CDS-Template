...
class MyBatchAStreamTwoSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyBatchAStreamTwoSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((batchAStreamTwo) => batchAStreamTwo.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((batchAStreamTwo) => batchAStreamTwo.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          batchAStreamTwoNotifier.currentBatchAStreamTwo = search[position];
