...
class _BatchBStreamOneDetailsPageState extends State<BatchBStreamOneDetailsPage> {
                  ...
                  child: Card(
                    ...
                    shape: OutlineInputBorder(
                      borderSide: BorderSide(
                          color: Color.fromRGBO(95, 62, 86, 1).withOpacity(0.70), width: 4.0, style: BorderStyle.solid
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(batchBStreamOneNotifier.currentBatchBStreamOne.name.toUpperCase(),
                          ...
                          (() {
                            if (batchBStreamOneNotifier.currentBatchBStreamOne.cdsExecutive == "Yes") {
                              return
                                Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: CupertinoSlidingSegmentedControl<int>(
                          ...
                          backgroundColor: Color.fromRGBO(95, 62, 86, 1).withAlpha(50),
  ...
  initState(){
    ...
    _courseOfStudy = batchBStreamOneNotifier.currentBatchBStreamOne.courseOfStudy;
    _graduationYear = batchBStreamOneNotifier.currentBatchBStreamOne.graduationYear;
    _linkedIn = batchBStreamOneNotifier.currentBatchBStreamOne.linkedIn;
    _ppaAssignment = batchBStreamOneNotifier.currentBatchBStreamOne.ppaAssignment;
    _cdsExecutive = batchBStreamOneNotifier.currentBatchBStreamOne.cdsExecutive;
    _cdsExecutivePosition = batchBStreamOneNotifier.currentBatchBStreamOne.cdsExecutivePosition;
...
//    _whatsNext = batchBStreamOneNotifier.currentBatchBStreamOne.whatsNext;
    ...
    _academicQualification = batchBStreamOneNotifier.currentBatchBStreamOne.academicQualification;
