...
BatchAStreamTwoNotifier batchAStreamTwoNotifier;
...
class BatchAStreamTwoDetailsPage extends StatefulWidget {
  @override
  _BatchAStreamTwoDetailsPageState createState() => _BatchAStreamTwoDetailsPageState();
}

class _BatchAStreamTwoDetailsPageState extends State<BatchAStreamTwoDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    batchAStreamTwoNotifier = Provider.of<BatchAStreamTwoNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(batchAStreamTwoNotifier.currentBatchAStreamTwo.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: batchAStreamTwoNotifier.currentBatchAStreamTwo.image,
                        fit: BoxFit.cover,
                  ...
                  message: batchAStreamTwoNotifier.currentBatchAStreamTwo.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(batchAStreamTwoNotifier.currentBatchAStreamTwo.name.toUpperCase(),
                            ...
                            (() {
                              if (batchAStreamTwoNotifier.currentBatchAStreamTwo.cdsExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    BatchAStreamTwoNotifier batchAStreamTwoNotifier = Provider.of<BatchAStreamTwoNotifier>(context, listen: false);

    _autoBio = batchAStreamTwoNotifier.currentBatchAStreamTwo.autoBio;
    _bestMoment = batchAStreamTwoNotifier.currentBatchAStreamTwo.bestMoment;
    _courseOfStudy = batchAStreamTwoNotifier.currentBatchAStreamTwo.courseOfStudy;
    _graduationYear = batchAStreamTwoNotifier.currentBatchAStreamTwo.graduationYear;
    _linkedIn = batchAStreamTwoNotifier.currentBatchAStreamTwo.linkedIn;
    _ppaAssignment = batchAStreamTwoNotifier.currentBatchAStreamTwo.ppaAssignment;
    _cdsExecutive = batchAStreamTwoNotifier.currentBatchAStreamTwo.cdsExecutive;
    _cdsExecutivePosition = batchAStreamTwoNotifier.currentBatchAStreamTwo.cdsExecutivePosition;
    _ppaLocation = batchAStreamTwoNotifier.currentBatchAStreamTwo.ppaLocation;
    _ppaName = batchAStreamTwoNotifier.currentBatchAStreamTwo.ppaName;
    _originState = batchAStreamTwoNotifier.currentBatchAStreamTwo.stateOfOrigin;
    _snapchat = batchAStreamTwoNotifier.currentBatchAStreamTwo.snapchat;
    _tikTok = batchAStreamTwoNotifier.currentBatchAStreamTwo.tikTok;
    _platoon = batchAStreamTwoNotifier.currentBatchAStreamTwo.stateOfOrigin;
    _campState = batchAStreamTwoNotifier.currentBatchAStreamTwo.stateOfOrigin;
    _whatsNext = batchAStreamTwoNotifier.currentBatchAStreamTwo.whatsNext;
    _stateLiving = batchAStreamTwoNotifier.currentBatchAStreamTwo.whereYouLive;
    _bestMoment = batchAStreamTwoNotifier.currentBatchAStreamTwo.bestMoment;
    _dob = batchAStreamTwoNotifier.currentBatchAStreamTwo.dob;
    _academicQualification = batchAStreamTwoNotifier.currentBatchAStreamTwo.academicQualification;
    _almaMater = batchAStreamTwoNotifier.currentBatchAStreamTwo.almaMater;
    _email = batchAStreamTwoNotifier.currentBatchAStreamTwo.email;
    _facebook = batchAStreamTwoNotifier.currentBatchAStreamTwo.facebook;
    _hobbies = batchAStreamTwoNotifier.currentBatchAStreamTwo.hobbies;
    _instagram = batchAStreamTwoNotifier.currentBatchAStreamTwo.instagram;
    _myDropline = batchAStreamTwoNotifier.currentBatchAStreamTwo.myDropline;
    _name = batchAStreamTwoNotifier.currentBatchAStreamTwo.name;
    _nickname = batchAStreamTwoNotifier.currentBatchAStreamTwo.nickname;
    _philosophy = batchAStreamTwoNotifier.currentBatchAStreamTwo.philosophy;
    _phone = batchAStreamTwoNotifier.currentBatchAStreamTwo.phone;
    _twitter = batchAStreamTwoNotifier.currentBatchAStreamTwo.twitter;
    _worstMoment = batchAStreamTwoNotifier.currentBatchAStreamTwo.worstMoment;
    _nyscBatch = batchAStreamTwoNotifier.currentBatchAStreamTwo.nyscBatch;
    _occupation = batchAStreamTwoNotifier.currentBatchAStreamTwo.occupation;
