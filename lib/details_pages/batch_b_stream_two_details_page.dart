...
class _BatchBStreamTwoDetailsPageState extends State<BatchBStreamTwoDetailsPage> {
  ...
  initState(){
    ...
    _course_of_study = batchBStreamTwoNotifier.currentBatchBStreamTwo.course_of_study;
    _graduation_year = batchBStreamTwoNotifier.currentBatchBStreamTwo.graduation_year;
    _linkedin = batchBStreamTwoNotifier.currentBatchBStreamTwo.linkedin;
    _ppa_assignment = batchBStreamTwoNotifier.currentBatchBStreamTwo.ppa_assignment;
    _cds_executive = batchBStreamTwoNotifier.currentBatchBStreamTwo.cds_executive;
    _cds_executive_position = batchBStreamTwoNotifier.currentBatchBStreamTwo.cds_executive_position;
    _ppa_location = batchBStreamTwoNotifier.currentBatchBStreamTwo.ppa_location;
    _ppa_name = batchBStreamTwoNotifier.currentBatchBStreamTwo.ppa_name;
    _state_of_origin = batchBStreamTwoNotifier.currentBatchBStreamTwo.state_of_origin;
    _whats_next = batchBStreamTwoNotifier.currentBatchBStreamTwo.whats_next;
    _where_you_live = batchBStreamTwoNotifier.currentBatchBStreamTwo.where_you_live;
    _bestmoment = batchBStreamTwoNotifier.currentBatchBStreamTwo.bestmoment;
    _d_o_b = batchBStreamTwoNotifier.currentBatchBStreamTwo.d_o_b;
    _academic_qualification = batchBStreamTwoNotifier.currentBatchBStreamTwo.academic_qualification;
    _alma_mater = batchBStreamTwoNotifier.currentBatchBStreamTwo.alma_mater;
    ...
    _my_dropline = batchBStreamTwoNotifier.currentBatchBStreamTwo.my_dropline;
    ...
    _worst_moment = batchBStreamTwoNotifier.currentBatchBStreamTwo.worst_moment;
